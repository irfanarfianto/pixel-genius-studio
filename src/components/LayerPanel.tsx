        ...
        <div className="glass-panel h-full flex flex-col overflow-hidden">
            ...
            `}
                    >
                        ...
                        {/* Layer Name */}
                        <span className={`flex-1 text-sm font-medium select-none ${activeLayerId === layer.id ? 'text-indigo-900' : 'text-gray-600'}`}>
                            {layer.name}
                        </span>
            ...
            <div className="p-4 border-t border-gray-200/50 bg-gray-50/50">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs font-mono text-gray-500">
                        {layers.find(l => l.id === activeLayerId)?.opacity ? Math.round(layers.find(l => l.id === activeLayerId)!.opacity * 100) : 100}%
                    </span>
                </div>
                <input
                    type="range"
