...
export const Header: React.FC = () => {
  ...
  return (
    <div className="glass-panel px-3 py-2 md:px-6 md:py-3 flex items-center justify-between shrink-0 gap-2">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="flex gap-1 p-1 bg-gray-100/50 rounded-xl">
          ...
          <button
            ...
            onClick={redo}
            disabled={
              !historyStack.length || historyStep >= historyStack.length - 1
            }
          >
            <svg
              width="18"
      ...
      {/* Layer Toggle */}
      <button
        className={`modern-button px-3 py-1.5 md:px-4 md:py-2 rounded-xl text-sm font-medium transition-all flex items-center gap-2 ${
          isLayerPanelOpen
